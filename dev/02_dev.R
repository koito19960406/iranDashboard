...
golem::add_module(name = "indicator_selection", with_test = TRUE) # Name of the module
...
usethis::use_data_raw(name = "shapefile_list", open = FALSE)
...
## Vignette ----
usethis::use_vignette("iranDashboard")
